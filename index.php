...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">Fonctions</a>
          </li>
          <li class="nav-item">
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1>Plateforme CHU Bab El Oued</h1>
  ...
  <section id="services" class="bg-light">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2><strong>Vous pourez:</strong></h2>
          <hr />
<p><strong>Introduire les informations relatives au test!</strong><br />
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
             <hr />
<p><strong>Suivre chaque patient!</strong><br />
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
          <hr />
<p><strong>Imprimer en format PDF!</strong><br />
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
        </div>
      </div>
    </div>
